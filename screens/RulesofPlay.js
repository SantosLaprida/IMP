      ...
      {isEnglish ? (
        <>
          ...
          <Text style={styles.paragraph}>
            ...
            official list. The amount of players depends on each tournament, and
            it is calculated based on the amount of players for that tournament.
            {"\n\n"}
          ...
          <Text style={styles.paragraph}>
            To qualify, at least one of your selected players must be among the
        ...
        <>
          ...
          <Text style={styles.paragraph}>
            ...
            torneo. La cantidad de jugadores depende de la cantidad de jugadores
            de ese torneo.{"\n\n"}
