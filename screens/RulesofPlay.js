        ...
        {isEnglish ? (
          <>
            ...
            <Text style={styles.paragraph}>
              To participate, you must select players from the tournament's
              official list. The amount of players depends on each tournament,
              and it is calculated based on the amount of players for that
              tournament.
              {"\n\n"}
              Selections can be made on Monday, Tuesday, and Wednesday.{"\n\n"}
              During this period, your selection can be modified as many times
              as you wish.{"\n\n"}
              On Thursday, during the first round of the tournament, an 18-hole
              medal play qualifier is played.{"\n\n"}
              At the end of the day, the top 8 players on the official
              leaderboard will qualify for the match play tournament.{"\n\n"}
              There is no automatic tiebreaker in case of a tie.
            </Text>

            <Text style={styles.subheading}>How to Qualify</Text>
            <Text style={styles.paragraph}>
              To qualify, at least one of your selected players must be among
              the top 8 on the leaderboard.{"\n\n"}
              Based on their ranking, your player/s will be placed in the draw.
              {"\n\n"}
            ...
            <Text style={styles.paragraph}>
              On Friday, the quarterfinals are played using the traditional
              match play draw format.{"\n\n"}
              Each match progresses as the players complete their rounds, and
              the app compares the holes already played to update the live or
              final match result.{"\n\n"}
              ...
              If a qualified player is unable to play on Friday for any reason,
              it will be considered a walkover (WO) for their opponent — the
              same applies for Saturday and Sunday matches.
            </Text>
          </>
        ) : (
          <>
            ...
            <Text style={styles.paragraph}>
              Para participar, se deben elegir jugadores de la lista oficial del
              torneo. La cantidad de jugadores depende de la cantidad de
              jugadores de ese torneo.{"\n\n"}
            ...
            <Text style={styles.paragraph}>
              Para clasificar, al menos uno de los jugadores seleccionados debe
            ...
            <Text style={styles.paragraph}>
              El viernes se juegan los cuartos de final con el formato clásico
              de match play.{"\n\n"}
              Cada partido avanza a medida que los jugadores completan sus
              rondas, y la app compara los hoyos ya jugados para mostrar el
              resultado parcial o final.{"\n\n"}
              En caso de empate, se vuelve al hoyo 1 y el primer jugador que
              gane un hoyo será el ganador.{"\n\n"}
...
const styles = StyleSheet.create({
  ...
  scrollContent: {
    padding: 50,
    paddingTop: 100,
    paddingBottom: 120, // Extra space so nothing is hidden behind the fixed button
  },
